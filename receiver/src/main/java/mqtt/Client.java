...
//mqttclient를 생성하고 callback을 이용하여 일정시간 동안 subscribe
public class Client implements MqttCallback {
     ...
     * **/
    public Client (Consumer<HashMap<Object, Object>> fnc){
        this.FNC = fnc;
    }
	
    /**
     * 설정파일을 등록합니다.<br>
     * 파라미터는 총 2개가 필요합니다.<br>
     * 주소, 접속후에 사용할 아이디값 입니다.
     * */
    public Client init(String serverURI, String clientId){
